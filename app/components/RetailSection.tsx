...
export default function RetailSection() {
  ...
  const filteredSpaces =
    activeFilter === "All"
      ? retailSpaces
      : retailSpaces.filter(
          (space) => space.category === activeFilter
        );
  ...
  return (
    <section id="retail" className="section-padding relative">
